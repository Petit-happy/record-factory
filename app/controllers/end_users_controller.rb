class EndUsersController < ApplicationController
  ...
  private
    ...
    def end_user_params
      params.require(:end_user).permit(:family_name_kanji, :given_name_kanji, :family_name_kana, :given_name_kana, :address, :post_code, :email, :password, :phone_number, :is_deleted)
    end
end
